...
def main():
    ...
    audio_formatter.main()

    dir_path = os.getcwd()
    audio_file_path = f'{dir_path}/processed_audio/'
    for item in os.listdir(audio_file_path):
        suffix = '.wav'
        if item.endswith(suffix):
            audio = f'{audio_file_path}{item}'
    ...
    # Moving transcription file into it's own folder
    for txt_file in os.listdir(dir_path + '/processed_audio/'):
        if txt_file.endswith('.txt'):
            if not os.path.isdir(f'{dir_path}/transcription'):
                os.mkdir(f'{dir_path}/transcription')
            shutil.move(f'{dir_path}/processed_audio/{txt_file}', f'{dir_path}/transcription/{txt_file}')
    
    # Deleting files
    for file in os.listdir(f'{dir_path}/audio_files/'):
        os.remove(f'{dir_path}/audio_files/{file}')
    for file in os.listdir(f'{dir_path}/processed_audio/'):
        os.remove(f'{dir_path}/processed_audio/{file}')
